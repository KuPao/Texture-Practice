...
public:
	...
	OpenMesh::VPropHandleT<OMT::FVIter> Mapping_ID;
	OpenMesh::VPropHandleT<double> coordX;
	OpenMesh::VPropHandleT<double> coordY;
	OpenMesh::VPropHandleT<VandW> weights;

	void Render_Solid();
	void Render_SolidWireframe();
	void Render_SolidWireframe2();
	void Render_Wireframe();
	void Render_Point();
	void Render_Face(FIter tmpF);
...
void pChosen(OMT::FVIter tmp, Tri_Mesh *mesh);
void fChosen(OMT::FIter tmpF, Tri_Mesh *mesh);
#endif
